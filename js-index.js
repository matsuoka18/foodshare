...
function jump_genre(g_data){
var genre_data = "genre_data="+g_data+"!";
document.cookie = genre_data;
location.href = "genre.html";
}
document.getElementById("ge1").addEventListener('click',()=>{
g_data = "udon";
jump_genre(g_data);
});
document.getElementById("ge2").addEventListener('click',()=>{ g_data = "okonomi";
jump_genre(g_data);
});
document.getElementById("ge3").addEventListener('click',()=>{ g_data = "sushi";
jump_genre(g_data);
});
document.getElementById("ge4").addEventListener('click',()=>{ g_data = "ramen";
jump_genre(g_data);
});
document.getElementById("ge5").addEventListener('click',()=>{ g_data = "tonkastu";
jump_genre(g_data);
});
document.getElementById("ge6").addEventListener('click',()=>{ g_data = "katsu";
jump_genre(g_data);
});
document.getElementById("ge7").addEventListener('click',()=>{ g_data = "kaisen";
jump_genre(g_data);
});
document.getElementById("ge8").addEventListener('click',()=>{ g_data = "agemono";
jump_genre(g_data);
});
document.getElementById("ge9").addEventListener('click',()=>{ g_data = "takoyaki";
jump_genre(g_data);
});
document.getElementById("ge10").addEventListener('click',()=>{ g_data = "tori";
jump_genre(g_data);
});
document.getElementById("ge11").addEventListener('click',()=>{ g_data = "sonota";
jump_genre(g_data);
});
document.getElementById("ge12").addEventListener('click',()=>{ g_data = "han";
jump_genre(g_data);
});
document.getElementById("ge13").addEventListener('click',()=>{ g_data = "piza";
jump_genre(g_data);
});
document.getElementById("ge14").addEventListener('click',()=>{ g_data = "pasuta";
jump_genre(g_data);
});
document.getElementById("ge15").addEventListener('click',()=>{ g_data = "hanbagu";
jump_genre(g_data);
});
document.getElementById("ge16").addEventListener('click',()=>{ g_data = "stake";
jump_genre(g_data);
});
document.getElementById("ge17").addEventListener('click',()=>{ g_data = "chiken";
jump_genre(g_data);
});
document.getElementById("ge18").addEventListener('click',()=>{ g_data = "american";
jump_genre(g_data);
});
document.getElementById("ge19").addEventListener('click',()=>{ g_data = "french";
jump_genre(g_data);
});
document.getElementById("ge20").addEventListener('click',()=>{ g_data = "italy";
jump_genre(g_data);
});
document.getElementById("ge21").addEventListener('click',()=>{ g_data = "spein";
jump_genre(g_data);
});
document.getElementById("ge22").addEventListener('click',()=>{ g_data = "sonotaE";
jump_genre(g_data);
});
document.getElementById("ge23").addEventListener('click',()=>{ g_data = "sonota";
jump_genre(g_data);
});
document.getElementById("ge24").addEventListener('click',()=>{ g_data = "chuka";
jump_genre(g_data);
});
document.getElementById("ge25").addEventListener('click',()=>{ g_data = "asia";
jump_genre(g_data);
});
document.getElementById("ge26").addEventListener('click',()=>{ g_data = "yakiniku";
jump_genre(g_data);
});
document.getElementById("ge27").addEventListener('click',()=>{ g_data = "pan";
jump_genre(g_data);
});
document.getElementById("ge28").addEventListener('click',()=>{ g_data = "suite";
jump_genre(g_data);
});
document.getElementById("ge29").addEventListener('click',()=>{ g_data = "drink";
jump_genre(g_data);
});
document.getElementById("ge30").addEventListener('click',()=>{ g_data = "nabe";
jump_genre(g_data);
});
document.getElementById("ge31").addEventListener('click',()=>{ g_data = "sonota";
jump_genre(g_data);
});
document.getElementById("ge32").addEventListener('click',()=>{ g_data = "udon";
jump_genre(g_data);
});
